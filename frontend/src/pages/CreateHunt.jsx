...
export default function CreateHunt() {
  ...
  const conditionLabel = CONDITIONS.find((c) => c.code === condition)?.label || condition;
    ...
    return (
      <div className="max-w-[560px] mx-auto fade-in-up space-y-6" data-testid="review-hunt-page">
        ...
        <div className="card-panel px-5 py-1" data-testid="review-details">
          ...
          <DetailRow Icon={DollarSign} label="Minimum price" value={`$${minPrice} ${currency}`} testid="row-price" />
     ...
     <div className="flex gap-6 min-w-0 fade-in-up" data-testid="list-remix-page">
      <div className="flex-1 min-w-0 space-y-6">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="font-serif text-[34px] sm:text-[38px] leading-none">Create your hunt</h1>
          </div>
          <p className="text-[13px] text-[var(--text-muted)] ml-14">You&apos;re creating your own hunt.</p>
        </div>
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              value={minPrice}
              onChange={(e) => setMinPrice(e.target.value.replace(/\D/g, "").slice(0, 6))}
              placeholder="0"
      ...
      <div className="grid grid-cols-2 gap-3 pt-2">
        ...
        <button
          ...
          className="rounded-xl py-3 font-semibold text-[13px] text-white transition hover:-translate-y-0.5"
          style={{ background: "linear-gradient(90deg, #8b5cf6, #6d28d9)", boxShadow: "0 6px 20px var(--accent-glow)" }}
        >
          Create Hunt
        </button>
      </div>
